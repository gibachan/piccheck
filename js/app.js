    ...
    return (
      React.createElement("div", {className: "container"}, 
        ...
        React.createElement("div", {className: "row"}, 
          React.createElement(ImageArea, {image: this.state.image})
        ), 
        React.createElement("hr", null), 
        React.createElement("div", {className: "row"}, 
          React.createElement(MapArea, {latitude: this.state.latitude, longtitude: this.state.longtitude}), 
          React.createElement(ExifArea, {exif: this.state.exif})
        )
      )
    );
  }
  ...
  render: function() {
    return (
      React.createElement("div", {className: "page-header"}, 
        React.createElement("h1", null, "piccheck ", React.createElement("small", null, "画像データに埋め込まれているEXIFデータを確認できます。"))
      )
    );
  }
});

var ImageArea = React.createClass({displayName: "ImageArea",
  propTypes: {
  ...
  render: function() {
    ...
    if (this.props.image.length > 0) {
      img = (
        React.createElement("img", {src: this.props.image, className: "picture", onDragOver: this.onDragOver, onDrop: this.onDrop})
      );
    } else {
      img = (
        React.createElement("img", {src: "./image/noimage.png", className: "picture", onDragOver: this.onDragOver, onDrop: this.onDrop})
      );
    }
    return (
      React.createElement("div", {className: "col-sm-12"}, 
        React.createElement("h2", null, "画像ファイル"), 
        img, 
        React.createElement("input", {type: "file", name: "imageFile", onChange: this.onSelectFile})
      )
    );
  }
});

var ExifArea = React.createClass({displayName: "ExifArea",
  propTypes: {
  ...
  render: function() {
    ...
    for (var name in this.props.exif) {
      if (name !== 'undefined') {
        rows.push(React.createElement(ExifRow, {key: name, name: name, value: this.props.exif[name] + ''}));
      }
    }
    return (
      React.createElement("div", {className: "col-sm-6"}, 
        React.createElement("h2", null, "EXIFデータ"), 
...
var ExifRow = React.createClass({displayName: "ExifRow",
  propTypes: {
...
var MapArea = React.createClass({displayName: "MapArea",
  propTypes: {
  ...
  render: function() {
    if (this.props.latitude == null ||
      ...
      return (
        React.createElement("div", {className: "col-sm-6"}, 
          React.createElement("h2", null, "マップ"), 
          React.createElement("img", {src: "./image/nomap.png", className: "nomap"}), 
          React.createElement("p", null, "*GPSデータが検出されると地図が表示されます")
        )
      );
    }
    ...
    return (
      React.createElement("div", {className: "col-sm-6"}, 
        ...
        React.createElement("p", null, "緯度: ", this.props.latitude), 
        React.createElement("p", null, "経度: ", this.props.longtitude)
      )
    );
  }
});
...
},{"react":157,"reflux":158}],2:[function(require,module,exports){
...
},{"eventemitter3":159,"native-promise-only":160}]},{},[1]);
